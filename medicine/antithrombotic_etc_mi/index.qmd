...
![DAPTの出血Risk](images/dapt_bleedingrisk.png)

[@Johnston2019-ca]

- 今回の場合は発症しばらく経過しているが出血Riskは高くなくDAPT導入は十分検討できる
  - 特に最初の1wkより前だと利益は大きそうに見える
  - 3wks後だと出血のRiskがBenefitを上回る
- 出血に関しては大体最初の週に0.3%, その後は0.05%程度の出血Risk
...
- 日本のRCT(ATIS-NVAF trial)
  ...
  - C: 抗凝固単剤
  - O: 
    - Primary: 2年以内の虚血イベント(心血管死亡+脳梗塞+MI+全身性塞栓症+血行再建)+有意な出血
      - 17.8% (11.0%-24.0%) vs. 19.6% (12.7%- 26.0%)(HR 0.91, 0.53- 1.55; p = .64)
    - 虚血イベント
      - 11.1% vs. 14.2% (HR 0.76, 0.39-1.48; p = .41)
    - 有意な出血
      - 9.4% vs. 5.6% (HR 1.63, 0.68-3.94; p = .27)
...
- 特にSepsisの場合はCHADS2-VAScは塞栓症のRiskとして使えず、観察研究ではあるが抗凝固と脳梗塞との関連は示されなかった
[@Walkey2016-mg; @Quon2018-gc]
