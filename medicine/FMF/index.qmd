...
![](images/autoinflammation.png){fig-alt="自己炎症と自己免疫の模式図" width="58%"}
...
::: {.big-message}
イメージは [**定期的な発熱 + 繰り返す虫垂炎**]{style="color: red;"}
:::
...
- 大まかなゲシュタルトとして若年者の<br>「繰り返す発熱と腹痛（+高CRP）」を忘れない
...
<!-- TODO: 元スライドは images/fmf_flowchart.png の画像。ここでは内容を Mermaid 化した下書きとして再構成。必要なら画像版も併記する。 -->
