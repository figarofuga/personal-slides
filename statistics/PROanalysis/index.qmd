...
ist3_dat_mod <- ist3_dat |>
    ...
    dplyr::select(itt_treat, age, sexm1, indepinadl_rand, antiplat_rand, atrialfib_rand, sbprand, dbprand, gcs_score_rand, nihss, sevendaycase, stroketype, R_infarct_size, ohs6, dead6mo, euroqol6, reverse_euroqol_comp, missing_euroqol)
...
gtsummary::tbl_summary(
    ...
    include = -c(euroqol6, dead6mo, reverse_euroqol_comp),
    value = list(
        sevendaycase ~ "Event",
        indepinadl_rand ~ 1,
        atrialfib_rand ~ 1,
