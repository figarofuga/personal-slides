...
ist3_dat_mod <- ist3_dat |> 
    dplyr::mutate(
        ...
        stroketype = dplyr::recode_values(
            ...
            4 ~ "POCI", 
            5 ~ "Other")) |> 
    dplyr::select(itt_treat, age, sexm1, indepinadl_rand, antiplat_rand, atrialfib_rand, sbprand, dbprand, gcs_score_rand, nihss, sevendaycase, stroketype, R_infarct_size, ohs6, dead6mo, euroqol6)
