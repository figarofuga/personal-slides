...
-   Patient reported outcomesの略 「 [PROとは、臨床家その他の誰の解釈も介さず、患者から直接得られた]{style="color:#333333"} [患者の健康状態に関するあらゆる報告である]{style="color:#333333"} 」 議論は複数あるが、HR-QOLを含む事が多い

# PROの代表例

![](imges/ordered_scale.png) - 循環器では以下のものが有名 \* SIHDで利用するSAQ \* 心不全で利用するKCCQ \* AFで利用するAFEQT \# 循環器の研究におけるPRO

![](images/num_publish_pro.png)

-   High impact journalではPROを含む研究が増えている！！ *J Am Heart Assoc* **. 2021;10(21):e022353.**
...
-   結局どれがいいの？ *Stat Methods Med Res* **. 2012;21(2):189-214.**

![](images/pro_analysis_real.png)

# 先行研究では？

![](images/pro_analysis_real2.png) - **多種多様な手法が使われており標準化されていない** *BMJ Open* **. 2021;11(9):e051673.**

# ガイドラインでは？

![](images/guideline_title.jpg) *The Lancet Oncology* 21 (2): e83–96.

# PROの確定的な解析方法は！！

![](images/no_consensus.png) *ない！* ・・・・・・
...
![](images/PROの解析について_8.png)

[**これらの解析ではMICを考慮する事が強く推奨！**]{style="color:#ff0000"}

*Chest* **. 2020;158(1S):S49-S56.**
...
*Stat Methods Med Res* **. 2012;21(2):189-214.**

**Piantadosi S, Meinert CL.** *Principles and Practice of Clinical Trials* **. 1st ed. (Meinert CL, ed.). Springer International Publishing; 2022.**

# ただし・・・・・・

![](images/PROの解析について_9.png)
...
*Circ Cardiovasc Qual Outcomes* **. 2013;6(5):591-597.**

*Circ Cardiovasc Qual Outcomes* **. 2019;12(6).**

# Visualizationについて

![](images/PROの解析について_11.jpg)

![](images/PROの解析について_12.png)

**個々人のPROMデータ: bar or Line plotが良い**

**治療群の平均のPROMデータ：Line plot, Pie chart \> bar chart**

*J Patient Rep Outcomes* **. 2022;6(1):18.**

# よりよい可視化のために

![](images/PROの解析について_13.png)

**・** **警告点を書く**

**・悪い結果を赤にする**

*Qual Life Res* **. 2019;28(2):345-356.**

# 群レベルのVisualization

![](images/PROの解析について_14.png)
...
[*Statistical Thinking – Proportional Odds Model Power Calculations for Ordinal and Mixed Ordinal/Continuous Outcomes (fharrell.com)*](https://www.fharrell.com/post/pop/)
...
![](images/PROの解析について_17.png)

![](images/PROの解析について_18.png)

# Baselineと1年後のAFEQTの関連

![](images/PROの解析について_19.png)

**Baselineと1年後のAFEQTのは相関している**

# 欠損値パターンについて

![](images/PROの解析について_20.png)

![](images/PROの解析について_21.png)
...
![](images/PROの解析について_22.png)

![](images/PROの解析について_23.png)
...
![](images/PROの解析について_24.png)

![](images/PROの解析について_25.png)

**全て同じ傾向で有意になっている**

**OLSとTobitはPowerが大きい**

![](images/PROの解析について_26.png)

![](images/PROの解析について_27.png)

**DiscriminationもCalibrationも大きく変わらない**
