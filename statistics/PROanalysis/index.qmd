...
ist3_dat_mod <- ist3_dat |>
    ...
    dplyr::select(treatment_dbl, treatment, age, sexm1, indepinadl_rand, antiplat_rand, atrialfib_rand, sbprand, dbprand, gcs_score_rand, nihss, sevendaycase, stroketype, R_infarct_size, ohs6, dead6mo, euroqol6, reverse_euroqol_comp, bad_euroqol_comp_bin, missing_euroqol)
...
- tPAha6ヶ月後の良いQOLと関連している結果となってしまった
- 一方で、どの解析も同じような結果だった
