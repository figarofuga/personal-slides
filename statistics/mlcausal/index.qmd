...
# 学習済みforestを固定し、学習時と同じ列順でtestデータを予測する。
...
# outcomeはイベントなので、符号を反転して「正ほど有益」にそろえる。
...
cfb_summary |> knitr::kable(digits = 3)
