...
summary(subclassification_fit)$Observation
...
[**この治療は眼の前の患者さんに有益ですか？**]{style="color: red;font-size: 1.2em;text-align=center"}
...
tibble::tibble(
  risk_category = rep(1:5, 100)
) |> 
  dplyr::mutate(
    predicted_ite = purrr::map_dbl(risk_category, \(x)rnorm(n = 1, mean = 0.1 * x, sd = 0.2)), 
    predicted_ite = dplyr::case_when(
      predicted_ite > 1 ~ 1, 
      predicted_ite < 0 ~ 0, 
      TRUE ~ predicted_ite
    )
