...
input_tbl |>
  ...
  knitr::kable(
    format = "html",
    align = "cccc",
    col.names = c("予測確率", "実際のアウトカム", "閾値:2.0e-07", "閾値2:4.50e-06")
  )
...
### 2. Class毎の予測確率の平均と<br>実際のイベント発症率を計算する
...
![](images/slide24_image01.png){fig-alt="NRIの図解" width="88%"}[@Alba2017-gh]
...
![](images/categoricalNRI.drawio.svg)
