...
::: {.column .fragment width="20%" fragment-index="1"}
...
::: {.column .fragment width="20%" fragment-index="2"}
...
input_tbl |>
  ...
  dplyr::mutate(
    predict_min = if_else(prob_Class1 > 1.794262e-07, "Class1", "Class2"), 
    predict_min_2  = if_else(prob_Class1 > 4.503066e-06 , "Class1", "Class2"), 
  ) |> head()
...
::: {.column .fragment width="20%" fragment-index="3"}
