...
<div class="flow-operation">
  <code>roc_curve()</code>
  <div class="flow-arrow">&rarr;</div>
  <div class="flow-caption">閾値を動かしながら<br>感度・特異度を計算</div>
</div>

:::

::: {.column .fragment width="44%" fragment-index="2"}
...
modeldata::two_class_example |> 
  ...
  dplyr::summarise(
    pct = mean(truth == "Class1"), .by = category
  ) |> 
  ggplot2::ggplot(aes(x = category, y = pct)) + 
